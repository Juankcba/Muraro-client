...
export default function Venta(props) {
    ...
    const onSharePress = (ventaOrden, ventaF, isVisibleF) => {
        if (isVisibleF) { var textoEstado = "Pagado"; }
        else { var textoEstado = "Impago"; }
        var messageText = '¡Muchas gracias por tu pedido!\n Tu orden es la numero:' + ventaOrden +
            '\n El monto de tu orden es: ' + ventaF.ventaPrecio +
            '\n El estado es:' + textoEstado;
        Share.share({
